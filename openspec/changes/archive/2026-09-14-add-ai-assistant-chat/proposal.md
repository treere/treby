...
- **Follow-ups (not in v1)**: Jido multi-agent, auto-discovered schemas, Action Layer + LiveView refactor, global drawer, bulk accept-all, retention pruning, applying form proposals to a live form (v1 proposals are advisory).
