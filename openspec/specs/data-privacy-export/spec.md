...
Provide async, tenant-isolated export of personal and workspace data as a ZIP package with time-limited signed URL, honoring data-subject access requests.
