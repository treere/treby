...
Define how the application resolves configuration from environment variables, including empty-value handling, a valid default development encryption key, and documented local setup.
