# opencode Tidewave Configuration

## Purpose
opencode configuration for AI-assisted Phoenix development via Tidewave MCP.

## Requirements

### Requirement: opencode configuration file
The system SHALL create an `opencode.json` file at the project root for opencode configuration.

#### Scenario: Configuration file exists
- **WHEN** developer examines the project root
- **THEN** `opencode.json` exists with proper structure
...
- **WHEN** developer examines `opencode.json`
