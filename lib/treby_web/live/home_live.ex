  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-white dark:bg-zinc-900">
        ...
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label={gettext("Global")}>
          ...
          <div class="flex items-center gap-x-4">
            ...
            <.link
              ...
              class="text-sm/6 font-semibold text-zinc-900 dark:text-zinc-100 hover:text-orange-600 transition-colors"
            >
              {gettext("Careers")}
            </.link>
            <.link
      ...
      <div class="relative isolate pt-14">
        ...
        >
          <div
            class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-orange-200 to-orange-400 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
      ...
      <%!-- Feature section --%>
      <div class="bg-zinc-50 dark:bg-zinc-800 py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-base font-semibold leading-7 text-orange-600">
              {gettext("Everything you need")}
            </h2>
            <p class="mt-2 text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 sm:text-4xl">
              {gettext("A better way to hire")}
            </p>
            <p class="mt-6 text-lg leading-8 text-zinc-500 dark:text-zinc-400">
              {gettext(
          ...
          <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              <div class="flex flex-col">
                <dt class="flex items-center gap-x-3 text-base font-semibold leading-7 text-zinc-900 dark:text-zinc-100">
                  <.icon name="hero-briefcase" class="h-5 w-5 flex-none text-orange-600" />
                  {gettext("Job Management")}
                </dt>
                <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-zinc-500 dark:text-zinc-400">
                  <p class="flex-auto">
                    {gettext(
              ...
              <div class="flex flex-col">
                <dt class="flex items-center gap-x-3 text-base font-semibold leading-7 text-zinc-900 dark:text-zinc-100">
                  <.icon name="hero-users" class="h-5 w-5 flex-none text-orange-600" />
              ...
              <div class="flex flex-col">
                <dt class="flex items-center gap-x-3 text-base font-semibold leading-7 text-zinc-900 dark:text-zinc-100">
                  <.icon name="hero-calendar" class="h-5 w-5 flex-none text-orange-600" />
