...
Provide a single, transparent view of an application's progress — current stage, what blocks advancement, and the concrete next actions — assembled on the fly for the team (pipeline cards and candidate detail). No new automation; purely an assembled, visible view.
