...
Provide an immutable, tenant-isolated audit trail for all state-changing actions, enabling admins to answer who changed what, when, and what the previous value was for compliance and operational trust.
