# Stage-Based Message Templates

## Purpose

Allow admins to configure templated messages that are posted to the candidate's portal conversation when candidates move to specific pipeline stages, automating routine communications like rejections and advances.
