            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
              <div class="mx-auto max-w-2xl text-center">
                <h1 class="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
                  Hire smarter with Treby
                </h1>
                <p class="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
                  Streamline your hiring process from job posting to offer letter. Manage candidates,
                  schedule interviews, and track your pipeline — all in one place.
                </p>
          ...
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
              ...
              <p class="mt-6 text-lg leading-8 text-gray-600">
                From posting jobs to extending offers, Treby gives you the tools to find and hire the
              ...
              <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                <div class="flex flex-col">
                  ...
                  <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                    <p class="flex-auto">
                      Create and manage job postings with custom fields, salary ranges, and
                      department assignments. Track applicants through your pipeline.
                    </p>
                  </dd>
                </div>
                <div class="flex flex-col">
                  ...
                  <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                    <p class="flex-auto">
                      Keep all candidate information in one place. Track resumes, notes, interview
                ...
                <div class="flex flex-col">
                  ...
                  <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                    <p class="flex-auto">
                      Schedule interviews with integrated calendar support. Candidates can
                      self-schedule using your custom booking page.
                    </p>
                  </dd>
                </div>
              </dl>
            ...
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
              <div>
                ...
                <p class="mt-4 text-sm leading-6 text-gray-600">
                  Modern applicant tracking for growing teams.
                </p>
              </div>
            </div>
            <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
              <p class="text-xs/6 text-gray-600">
                &copy; {DateTime.utc_now().year} Treby. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
