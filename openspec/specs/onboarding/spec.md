...
- **THEN** an empty state is displayed with an icon, title ("No job postings yet"), a brief description explaining what job postings do, and a "Create your first job" button linking to the job creation form
