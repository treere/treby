# Candidate Notifications Config

## Purpose

Allow candidates to configure their email notification preferences within the portal, giving them control over which updates they receive.
