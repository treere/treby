...
Provide a friendly, on-brand "Not Found" page and redirect to it when entity-detail routes reference records that do not exist, instead of rendering a stacktrace.
